...
<div className="w-full h-screen px-10 mx-auto bg-gradient-to-b from-black to-gray-800 p-4 text-white"   name="contact">
            ...
            <div className="flex items-start">
              <div className="shrink-0">
                <div className="p-4 bg-blue-600 rounded-md shadow-md w-14 h-14 flex items-center justify-center">
                  <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="phone" className="w-5 text-white"
              ...
              <div className="grow ml-6">
                ...
                <p className="text-white">+91 8866556966</p>
              </div>
            </div>
          </div>
          <div className="mb-12 grow-0 shrink-0 basis-auto w-full lg:w-6/12 px-3 lg:px-6">
            <div className="flex items-start">
              ...
              <div className="grow ml-6">
                <p className="font-bold mb-1 text-white">Instagram</p>
                <p className="text-white">@ankit_devani.17</p>
              </div>
            </div>
          </div>
          <div className="mb-12 grow-0 shrink-0 basis-auto w-full lg:w-6/12 px-3 lg:px-6">
            <div className="flex align-start">
              ...
              <div className="grow ml-6">
                ...
                <p className="text-white">devaniankit1990@gmail.com</p>
              </div>
            </div>
          </div>
          <div className="mb-12 grow-0 shrink-0 basis-auto w-full lg:w-6/12 px-3 lg:px-6">
            <div className="flex align-start">
              ...
              <div className="grow ml-6">
                <p className="font-bold mb-1 text-white">Whatsapp</p>
